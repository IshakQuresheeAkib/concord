            ...
            <div className="relative" >
                    ...
                    <div className="absolute top-0 left-0 w-full h-[50vh] pointer-events-none"></div>
                        <div className="relative ">
                            ...
                            <div className="relative xl:bottom-14 2xl:bottom-0 mx-auto overflow-hidden sm:max-w-2xl md:max-w-full 2xl:w-screen lg:px-24 px-6 xl:pt-44 py-28 2xl:py-36 h-screen">
                                <div className="w-full 2xl:pt-6 xl:w-full flex flex-col items-start">
                                    <h2 className="mb-3 text-6xl font-bold sm:text-7xl 2xl:text-8xl text-black">
                                        <span className="text-coral leading-tight">Ready to </span> 
                                        <br/>
                                        <span className="text-teal-600 leading-tight">Meet Your Match?</span>
                                    </h2>
