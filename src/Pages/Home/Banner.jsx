            ...
            <div className="relative" >
                    ...
                    <div className="absolute top-0 left-0 w-full h-[50vh] pointer-events-none"></div>
                        <div className="relative ">
                            ...
                            <div className="relative xl:bottom-14 2xl:bottom-0 mx-auto overflow-hidden sm:max-w-2xl md:max-w-full 2xl:w-screen lg:px-[75px] px-6 xl:pt-44 py-28 2xl:py-36 h-screen">
