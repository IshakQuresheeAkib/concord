    ...
    return (
        <div className="2xl:container 2xl:mx-auto lg:py-16 lg:px-20 md:py-12 md:px-6 py-9 px-4 mb-52 mt-10" >
            <div className="flex flex-col lg:flex-row justify-between gap-8">
                ...
                <div className="">
                    <img className="h-[500px]" loading="lazy" src="https://i.ibb.co/yFPJKpm/Untitled-designff-2.png" alt="A group of People" />
                </div>
            </div>
                ...
                <div className="w-full lg:w-8/12 lg:pt-8">
                    <div className="grid md:grid-cols-4 sm:grid-cols-2 grid-cols-1 lg:gap-4 shadow-lg rounded-md">
                        <div className="p-4 pb-6 flex justify-center flex-col items-center">
                            <img loading="lazy" className="md:block hidden rounded-xl" src="https://i.ibb.co/fx2B9sR/mitchell-luo-CMng5-Bz-Pv1o-unsplas.jpg" alt="Alexa featured Img" />
                            <p className="font-medium text-xl leading-5 text-gray-800 mt-4">Richard</p>
                            <small>CEO</small>
                        </div>
                        <div className="p-4 pb-6 flex justify-center flex-col items-center">
                            <img loading="lazy" className="md:block hidden rounded-xl" src="https://i.ibb.co/j5R8MGL/IMG-5522-02-jpeg.jpg" alt="Olivia featured Img" />
                            <p className="font-medium text-xl leading-5 text-gray-800 mt-4">Isaac</p>
                            <small>Coordinator</small>
                        </div>
                        <div className="p-4 pb-6 flex justify-center flex-col items-center">
                            <img loading="lazy" className="md:block hidden rounded-xl" src="https://i.ibb.co/q0BRVGJ/portrait-white-man-isolated-1.jpg" alt="Liam featued Img" />
                            <p className="font-medium text-xl leading-5 text-gray-800 mt-4">Liam</p>
                            <small>CTO</small>
                        </div>
                        <div className="p-4 pb-6 flex justify-center flex-col items-center">
                            <img loading="lazy" className="md:block hidden rounded-xl" src="https://i.ibb.co/x8MzXdr/redd-f-pz-OUnvx9c1-E-unsplash-1.jpg" alt="Elijah featured img" />
                            <img loading="lazy" className="md:hidden block" src="https://i.ibb.co/ThZBWxH/Rectangle-121.png" alt="Elijah featured img" />
