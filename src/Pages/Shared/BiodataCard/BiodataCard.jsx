...
const BiodataCard = ({biodata}) => {
    ...
    return (
        <div className="w-full mt-7 2xl:max-w-sm max-w-xs overflow-hidden rounded-lg shadow-lg group" data-aos='slide-up' data-aos-once="true">
                ...
                <div className="px-3 py-6 text-left duration-700 transition group-hover:bg-teal group-hover:text-white">
                    <h1 className="text-xl font-semibold ">Biodata ID: {BiodataId}</h1>                  
                    <div className="flex items-center mt-4 text-gray-700 dark:text-gray-200 group-hover:text-white">
