...
export const MobileMenuToggle = ({ mobileMenuOpen, setMobileMenuOpen }) => (
...
export const MobileMenuOverlay = ({ mobileMenuOpen, setMobileMenuOpen, user, loading, handleLogin, dashboardLink, navbarItems1 }) => (
    <AnimatePresence>
        {mobileMenuOpen && (
            <>
                <motion.div
